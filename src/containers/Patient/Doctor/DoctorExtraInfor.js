                ...
                <div className='content-down'>
                    {isShowDetailInfor === false &&
                        <div className='short-infor'>
                            <div className='title-price-show'>
                            ...
                            <span className='detail' onClick={() => this.showHideDetailInfor(true)}>
                                <FormattedMessage id='patient.extra-infor-doctor.show-price' />
                            </span>
                        </div>
                    }
                    {isShowDetailInfor === true &&
                        <>
                            <div className='title-price-hide'><FormattedMessage id='patient.extra-infor-doctor.price' />:</div>
