...
const hadleLoginApi = (userEmail, userPassword) => {
...
const getAllCodeServer = (inputType) => {
...
export {
    hadleLoginApi, getAllUsers, createNewUserService, deleteUserService,
    editUserService, getAllCodeServer, getTopDoctorHomeService, getAllDoctors,
    ...
    postPatientBookApointment, postVerifyBookApointment, createNewSpecialty, getAllSpecialty,
    getDetailDoctoById, createNewClinic, getAllClinic, getDetailClinicById,
